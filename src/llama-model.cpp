        ...
        default:
            {
                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (arch == LLM_ARCH_FALCON_H1) {
                    ...
                    } else if (arch == LLM_ARCH_QWEN3NEXT || arch == LLM_ARCH_QWEN35 || arch == LLM_ARCH_QWEN35MOE || arch == LLM_ARCH_GLM5NEXT || arch == LLM_ARCH_QWEN4EXP) {
                        filter_attn = [&](uint32_t il) {
                        ...
                        } else if (arch == LLM_ARCH_QWEN4EXP && hparams.indexer_head_size > 0) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_memory_hybrid_iswa(
                            ...
                            /* attn_n_pad        */ 1,
                            /* recurrent_type_r  */ params.type_r,
                        ...
                        res = new llama_memory_hybrid(
                            ...
                            /* attn_n_swa        */ hparams.n_swa,
                            /* attn_swa_type     */ hparams.swa_type,
                            /* recurrent_type_k  */ params.type_r,
